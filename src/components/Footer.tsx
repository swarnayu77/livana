        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-3">
              ...
              <span className="text-base font-display font-bold text-foreground">LIVANA</span>
            </Link>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              ...
              <Link to="/meal-plans" className="block text-sm text-muted-foreground hover:text-primary transition-colors">Meal Plans</Link>
              <Link to="/coach" className="block text-sm text-muted-foreground hover:text-primary transition-colors">AI Coach</Link>
            </div>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-4">Resources</h4>
            <div className="space-y-2.5">
              <Link to="/recipes" className="block text-sm text-muted-foreground hover:text-primary transition-colors">Recipes</Link>
              <Link to="/goals" className="block text-sm text-muted-foreground hover:text-primary transition-colors">Goals</Link>
              <Link to="/progress" className="block text-sm text-muted-foreground hover:text-primary transition-colors">Progress</Link>
            </div>
          </div>
          <div>
