            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <h4 className="font-semibold text-sm text-foreground group-hover:text-primary transition-colors duration-200">{meal.name}</h4>
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                  {meal.tags.map((tag) => (
                    <span key={tag} className="px-2.5 py-1 text-[10px] rounded-full bg-primary/8 text-primary font-medium">{tag}</span>
                  ))}
                </div>
              </div>
            </div>
